...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("resources/icons8-menu-64.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.horizontalLayout_3.addWidget(self.frame_7, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        self.horizontalLayout_3.addWidget(self.frame_8, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("resources/icons8-minimize-64.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("resources/icons8-maximize-64.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("resources/icons8-exit-64.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.horizontalLayout_3.addWidget(self.frame_9, 0, QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        self.verticalLayout_7.addWidget(self.label_4, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.verticalLayout_9.addWidget(self.label_5, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.verticalLayout_13.addWidget(self.label_7, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.verticalLayout_15.addWidget(self.label_8, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.verticalLayout_17.addWidget(self.label_9, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.left_bottom_menu_widget = QtWidgets.QWidget(parent=self.centralwidget)
        self.left_bottom_menu_widget.setObjectName("left_bottom_menu_widget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.left_bottom_menu_widget)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.label_10)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.label_12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Wind Direction Vs Time"))
